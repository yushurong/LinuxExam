...
public class GetNotepadById extends HttpServlet {
    ...
    static final String DB_URL = "jdbc:mysql://123.60.79.203/LinuxExam";
    static final String USER = "root";
    static final String PASS = "Quanzhilong795.";
    static final String SQL_QURERY_NOTEPAD_BY_ID = "SELECT id, name FROM t_notepad WHERE id=?";
